...
Route::get('/patient/download/{id}', [PatientRecord::class, 'download'])->name('patient_download')->where('id', '[0-9]+')->middleware('auth', 'role:patient');
...
//doctor
Route::get('/doctor/download/{id}', [DoctorRecord::class, 'download'])->name('doctor_download')->where('id', '[0-9]+')->middleware('auth', 'role:doctor');
...
Route::delete('/doctor/dossier/{id}/delete', [DoctorRecord::class, 'deleteRecordOfPatient'])->name('doctor_delete_file')->where('id', '[0-9]+')->middleware('auth', 'role:doctor');
